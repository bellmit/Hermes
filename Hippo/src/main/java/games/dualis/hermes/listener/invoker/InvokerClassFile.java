...
import games.dualis.hermes.io.ByteBuffer;
 ...
 * </p>
 */
public final class InvokerClassFile {
     ...
     */
    public InvokerClassFile(Class<?> parent, Class<?> topic, Method method, String className) {
        this.parent = parent;
        this.topic = topic;
        this.method = method;
    ...
    public byte[] toByteArray() throws IOException {
        ...
        String listenerInternal = Invoker.class.getName().replace('.', '/');
